...
<div class="panel-group" id="accordion3">
  <div class="panel panel-info">
    ...
    <div id="collapse3" class="panel-collapse collapse">
	  ...
	  <i>(c) 2015 by <a href="mailto:felix@nicebread.de">Felix Schönbrodt</a> (<a href="http://www.nicebread.de">www.nicebread.de</a>). The source code of this app is licensed under the open GPL-2 license and is published on <a href="https://github.com/nicebread/p-checker">Github</a>.</i>
	  <br><br>
	  ...
	  <br/><br/>
	  Sch�nbrodt, F. D. (2015). <i>p-checker: One-for-all p-value analyzer.</i> Retrieved from http://shinyapps.org/apps/p-checker/.
	  <br/><br/>	  
